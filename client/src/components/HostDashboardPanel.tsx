        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {hostedGames.map((g) => (
            <button
              ...
              style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: colors.bg, border: "none", borderRadius: 10, padding: "10px 14px", fontSize: 13.5, cursor: "pointer", textAlign: "left" }}
            >
